...
This is the mechanically generated cumulative product-path inventory for the
MiniMax rebuild. It must equal the output of:
`git diff --name-only 9b1673a10aaa9e5f96c8a1233cdd5fb531a78c2a HEAD -- inferno-frontend/src`
after stripping the `inferno-frontend/src/` prefix.
