...
> Historical execution notes from August/September 2026. Any dated agent
> RUNNING/queued counts below are not current. The live selective-upstream
> status and pending queue are maintained only in
> `docs/superpowers/analysis/RECONCILIATION.md`.
...
| field | value |
|---|---|
| historical manifest | `docs/superpowers/analysis/archive/2026-09-23/COMMIT-MANIFEST.md` — legacy script input, not live status |
...
| field | value |
|---|---|
| historical manifest | `docs/superpowers/analysis/archive/2026-09-23/COMMIT-MANIFEST.md`, Set B table |
...
Distilled historical findings are preserved in
`docs/superpowers/analysis/archive/2026-09-23/FILE-SWEEP-FINDINGS.md`.
