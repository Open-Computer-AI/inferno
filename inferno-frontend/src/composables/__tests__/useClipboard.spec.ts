...
describe('useClipboard', () => {
  ...
  it.each([false, true])('fallback exceptions are reported as copy failures (secure context: %s)', async (secure) => {
    Object.defineProperty(window, 'isSecureContext', { value: secure, writable: true })
