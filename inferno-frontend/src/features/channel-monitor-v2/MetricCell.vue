...
const stateClass = computed(() => {
  ...
  if (resolvedState.value === 'healthy') return 'text-[var(--success)] text-[var(--success)]'
  if (resolvedState.value === 'warning') return 'text-[var(--warning)] text-[var(--warning)]'
  if (resolvedState.value === 'critical') return 'text-[var(--destructive)] text-[var(--destructive)]'
...
const dotClass = computed(() => {
  ...
  if (missingValue.value) return 'bg-[var(--border-subtle)]'
