        ...
        <div class="space-y-6">
          ...
          <div class="settings-surface">
            ...
            <div class="space-y-6 p-6">
              <!-- Backend Mode -->
              <div
                class="flex items-center justify-between rounded-[var(--r-md)] border border-[var(--s2a-attn)] bg-[var(--s2a-attn-soft)] p-4               ">
                <div>
...
<h3 class="text-sm font-[var(--fw-medium)] text-[var(--foreground)] ">
              ...
              <div>
                ...
                <!-- iframe CSP Warning -->
                <p class="mt-2 text-xs text-[var(--s2a-attn)] ">
...
export default defineComponent({
  ...
  components: { BaseSelect, BaseButton, ImageUpload, Toggle },
  setup() {
