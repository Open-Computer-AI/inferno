  ...
  <div v-if="visible" class="oqr">
    ...
    <div class="oqr__actions">
      ...
      >
        ...
        <span class="oqr__points-value">{{ creditsDisplay }}</span>
      </button>

      <OpenAIReferralCell :account="account" />
    </div>

    <div v-if="creditsCacheWarning" class="oqr__feedback" data-tone="warning">
...
const handleQuery = async () => {
  ...
  try {
    ...
    if (props.account.id === accountID) error.value = extractErrorMessage(e)
  } finally {
