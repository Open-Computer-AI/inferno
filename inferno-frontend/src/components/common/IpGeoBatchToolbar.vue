<template>
  <div
    ...
    class="flex flex-shrink-0 items-center justify-end gap-2 border-b border-[var(--brand-line)] px-4 py-2 border-[var(--brand-line)]"
  >
    <span v-if="pendingCount > 0" class="text-xs text-[var(--muted-foreground)] text-[var(--muted-foreground)]">
