...
export const METHOD_ORDER = ['razorpay', 'alipay', 'alipay_direct', 'wxpay', 'wxpay_direct', 'stripe', 'airwallex'] as const
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  razorpay: [
    ...
    { key: 'currency', label: 'Payment currency', sensitive: false, defaultValue: 'INR', options: [{ value: 'INR', label: 'INR' }] },
  ],
}
