export default {
    ...
    dashboard: {
      ...
      tileRequestsRate: '近 5 分钟每分钟 {rate} 次',
      tileCostSaved: '标准 {standard}，节省 {saved}',
      tileCostStandard: '按标准价计费',
      tileKeysActive: '{count} 个启用中',
      tileUsersActive: '活跃 {active}，今日新增 {new}',
      tileUsersActiveOnly: '活跃 {active}',
      tileCacheShare: '{pct}% 来自缓存',
      tileNoTraffic: '暂无流量',
      tileAcrossRequests: '基于 {count} 次请求',
      apiKeys: 'API 密钥',
      ...
      cache: '缓存',
      recentUsage: '最近使用',
      acrossUsers: '{count} 位用户的每日 Token 用量',
      otherUsers: '其他（{count}）',
      tokensUnit: 'Token',
    ...
    backup: {
      ...
      archive: {
        title: '月度归档',
        description: '将选定日期的定时备份独立保留，不受常规保留策略影响。',
        enabled: '启用月度归档',
        dates: '归档日期',
        day: '第 {day} 天',
        monthEnd: '月末',
        datesHint: '如果某月不存在所选日期，则在该月最后一天创建归档。',
        retention: '月度归档保留策略',
        count: '保留的月度归档份数',
        copies: '份',
        forever: '永久保留',
        foreverHint: '月度归档不会被自动删除。',
        countHint: '仅保留最新的指定数量月度归档。',
        fallbackHint: '仅成功完成的定时备份会生成月度归档。',
        independentHint: '月度归档保留策略独立于常规过期时间和数量限制。',
        disabledHint: '月度归档已关闭；现有归档保留设置不会被更改。',
        daysRequired: '至少选择一个日期或月末。',
        countInvalid: '请输入正整数，或选择永久保留。',
        badge: '月度归档',
        retainLatest: '保留最新 {count} 份',
        deleteConfirm: '删除此月度归档及其所有归档副本？此操作无法撤销。'
      },
      operations: {
        title: '备份记录',
    ...
    affiliates: {
      ...
      withdraw: {
        ...
        title: '登记线下提现',
        user: '用户',
        userPlaceholder: '按邮箱、用户名或用户 ID 搜索',
        noUserFound: '未找到匹配用户',
        availableQuota: '可提现返利额度',
        frozenHint: '冻结额度不可提现。',
        amount: '已在线下支付的金额（USD）',
        amountHint: '最多 8 位小数。该操作会记录站外付款并扣减返利额度。',
        amountRequired: '请输入大于零的金额。',
        amountExceeds: '金额超过可提现返利额度。',
        fillAll: '全部提取',
        warning: '仅在用户已在线下收到付款后登记。此操作无法撤销。',
        uncertainHint: '暂未确认操作结果。请重试相同用户和金额；幂等键可防止重复扣款。',
        submit: '登记提现',
        submitting: '正在登记…',
        retry: '重试同一笔提现',
        success: '已登记线下提现 {amount}；剩余返利额度 {remaining}。',
        replayed: '该提现已登记：{amount}；剩余返利额度 {remaining}。'
      },
      overview: {
        title: '用户返利概览',
        affCode: '邀请码',
