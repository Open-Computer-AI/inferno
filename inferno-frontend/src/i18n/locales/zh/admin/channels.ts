export default {
    ...
    channels: {
      ...
      noGroupsSelected: '{platform}：保存前请至少选择一个分组',
      emptyModelsInPricing: '{platform}：每条价格配置至少需要一个模型',
      ...
      form: {
        ...
        reasoningEffortMultipliers: '思考等级倍率',
        reasoningEffortMultipliersHint: '可选的分等级计费倍率；留空时按 1 倍计费。',
        reasoningEffortMultiplierLabel: '{effort} 思考倍率',
        reasoningEffortMultiplierDefault: '默认（1 倍）',
        clearReasoningEffortMultipliers: '清除全部',
        reasoningEffortLevelInvalid: '未知思考等级：{effort}',
        reasoningEffortMultiplierPositive: '{effort} 倍率必须是大于 0 的有限数值',
        multiplierPlaceholder: '未设置',
        multiplierPositive: '倍率必须大于 0',
