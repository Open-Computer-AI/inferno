export default {
    ops: {
      ...
      systemLogs: {
        ...
        runtimeConfigHint: 'Applies immediately, without a restart.',
        samplingOn: 'sampling on',
        samplingOff: 'sampling off',
        retentionSummary: '{days}d retention',
        resetConfigTitle: 'Reset log configuration?',
        cleanupTitle: 'Clean up these logs?',
        emptyHint: 'No log lines matched these filters in this window.',
        anyLevel: 'Any level',
        all: 'All',
        level: 'Level',
      ...
      tpsK: 'TPS (K)',
      switchRateCaption: 'switches per request in this window',
      latency: {
      ...
      alertEvents: {
        title: 'Alert events',
        description: 'Recent alert firing and resolution records (email only)',
        loading: 'Loading...',
        empty: 'No alert events',
        emptyHint: 'Nothing has crossed a rule threshold in this window.',
        ...
        detail: {
          ...
          measured: 'Measured against threshold',
          historyTitle: 'History',
          historyHint: 'Recent events with the same rule and dimensions',
