export default {
    ...
    channels: {
      ...
      modelConflict: "Model patterns '{model1}' and '{model2}' conflict: overlapping match range. Model names are matched case-insensitively, so an existing entry already covers all case variants. There is no need to add the variant separately.",
      noGroupsSelected: '{platform}: select at least one group before saving',
      emptyModelsInPricing: '{platform}: every pricing entry needs at least one model',
      ...
      form: {
        ...
        reasoningEffortMultipliers: 'Reasoning-effort multipliers',
        reasoningEffortMultipliersHint: 'Optional per-level billing multiplier. Leave blank to use 1×.',
        reasoningEffortMultiplierLabel: '{effort} reasoning multiplier',
        reasoningEffortMultiplierDefault: 'Default (1×)',
        clearReasoningEffortMultipliers: 'Clear all',
        reasoningEffortLevelInvalid: 'Unknown reasoning effort level: {effort}',
        reasoningEffortMultiplierPositive: '{effort} multiplier must be a finite number greater than 0',
        multiplierPlaceholder: 'Not set',
        multiplierPositive: 'Multipliers must be greater than 0',
