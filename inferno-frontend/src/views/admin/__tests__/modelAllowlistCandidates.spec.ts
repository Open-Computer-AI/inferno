...
describe('modelAllowlistCandidates', () => {
  it('rejects stale candidate responses after a newer platform request starts', () => {
    ...
    const first = { mode: 'create' as const, groupID: 0, platform: 'openai' as const }
    const second = { mode: 'create' as const, groupID: 0, platform: 'anthropic' as const }
  ...
  it('rejects responses for a previous edit group even with the same platform', () => {
    const tracker = createModelAllowlistCandidatesTracker()
    const first = { mode: 'edit' as const, groupID: 10, platform: 'openai' as const }
    const second = { mode: 'edit' as const, groupID: 11, platform: 'openai' as const }
  ...
  it('tracks create and edit requests independently', () => {
    const tracker = createModelAllowlistCandidatesTracker()
    const editRequest = { mode: 'edit' as const, groupID: 10, platform: 'openai' as const }
    const createRequest = { mode: 'create' as const, groupID: 0, platform: 'anthropic' as const }
