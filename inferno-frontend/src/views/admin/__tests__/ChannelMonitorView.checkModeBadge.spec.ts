...
describe('ChannelMonitorView check-mode badge', () => {
  ...
  it.each([
    ...
    // Our tree tokenised upstream's neutral bg-gray-100 into NEUTRAL_BADGE
    // (useChannelMonitorFormat.ts:34). Same assertion, our literal.
    const NEUTRAL = 'bg-[var(--surface-subtle)]'
    if (mode === 'probe') {
