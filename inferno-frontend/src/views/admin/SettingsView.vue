  ...
  <AppLayout>
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        <SettingsTabsNav :tabs="settingsTabs" :active-tab="activeTab" @select="selectSettingsTab" />
...
import SettingsTabsNav, { type SettingsTab, type SettingsTabKey } from "@/views/admin/settings/SettingsTabsNav.vue";
...
function selectSettingsTab(tab: SettingsTabKey): void {
  activeTab.value = tab;
}
