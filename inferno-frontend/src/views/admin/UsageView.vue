...
const loadSavedColumns = () => {
  try {
    ...
    if (saved) {
      ...
      // One shot: an admin with a saved preference predating this column would
      // otherwise be handed an unexpected new column. Hide it once, then never
      // touch their choice again.
