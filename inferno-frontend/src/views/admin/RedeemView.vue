            ...
            <div class="space-y-2">
              ...
              <template v-if="batchUpdateForm.update_expires_at">
                ...
                <input
                  ...
                  class="input"
                />
                <p v-if="batchUpdateForm.expires_mode === 'custom'" class="text-sm text-gray-500 dark:text-gray-400">
...
import { formatDateTime, getBrowserTimeZone, parseDateTimeLocalInput } from '@/utils/format'
import type {
  RedeemCode,
  RedeemCodeType,
  Group,
