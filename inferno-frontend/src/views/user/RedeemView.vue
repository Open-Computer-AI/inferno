  ...
  <AppLayout>
    <div class="mx-auto max-w-2xl space-y-6">
      ...
      <transition name="fade">
        <div
          v-if="redeemResult"
          class="surface-card border-emerald-200 bg-emerald-50 dark:border-emerald-800/50 dark:bg-emerald-900/20"
        >
          <div class="p-6">
      ...
      <transition name="fade">
        <div
          v-if="errorMessage"
          class="surface-card border-red-200 bg-red-50 dark:border-red-800/50 dark:bg-red-900/20"
        >
          <div class="p-6">
            <div class="flex items-start gap-4">
              <div
      ...
      <!-- Information Card -->
      <div
        class="surface-card border-primary-200 bg-primary-50 dark:border-primary-800/50 dark:bg-primary-900/20"
      >
        <div class="p-6">
          <div class="flex items-start gap-4">
            <div
