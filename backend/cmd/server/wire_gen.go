...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	billingContractService := service.ProvideBillingContractService(billingCacheService, orgService, usageService, paymentConfigService, subscriptionService, paymentService, idempotencyCoordinator, configConfig)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, handlerOAuthHandler, billingContractHandler, idempotencyCoordinator, idempotencyCleanupService)
	...
	oAuthBackingKeyService := service.NewOAuthBackingKeyService(client, configConfig)
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, compositeRouteResolver, oAuthBackingKeyService, redisClient)
