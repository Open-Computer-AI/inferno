...
var providerSensitiveConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeRazorpay:  {"keysecret": {}, "webhooksecret": {}},
}
...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeRazorpay:  {"keyid": {}, "keysecret": {}, "webhooksecret": {}, "currency": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true, payment.TypeRazorpay: true,
}
