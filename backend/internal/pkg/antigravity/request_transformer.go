...
// stripClaudeAttribution removes a leading Claude Code attribution metadata
// line from Antigravity system text. It is intentionally limited to the
// transformer because native Anthropic forwarding may require that metadata.
