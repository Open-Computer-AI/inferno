...
// TestToolConfigAlwaysPresent ensures toolConfig is emitted for reasoning models
// without tools as well: the upstream endpoint rejects requests that omit it.
