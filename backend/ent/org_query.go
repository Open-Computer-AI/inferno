...
func (_q *OrgQuery) ForUpdate(opts ...sql.LockOption) *OrgQuery {
...
func (_q *OrgQuery) ForShare(opts ...sql.LockOption) *OrgQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
